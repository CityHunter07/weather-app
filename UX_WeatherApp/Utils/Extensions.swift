...
extension View {
    ...
    func innerShadow<S: Shape, SS: ShapeStyle>(shape: S, color: SS, lineWidth: CGFloat = 1, offsetX: CGFloat = 0, offsetY: CGFloat = 0, blur: CGFloat = 1, blendMode: BlendMode = .normal, opacity: Double = 0) -> some View {
        return self
            .overlay {
                shape
